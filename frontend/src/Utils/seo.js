    ...
    jsonLd: [
      {
        ...
        name: pageTitle,
        description,
        url: `https://stockscope.app/company/${encodeURIComponent(safeSymbol)}`,
        about: {
          '@type': 'Organization',
          name: companyName,
        },
      },
      {
        ...
        logo: 'https://stockscope.app/logo.png',
      ...
      },
      {
        ...
        potentialAction: {
          '@type': 'SearchAction',
          target: 'https://stockscope.app/search?q={search_term_string}',
